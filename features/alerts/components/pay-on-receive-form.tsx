    ...
    <Form {...form}>
      ...
      >
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 0) {
                          form.setValue("scheduledDays", value);
                        }
                      }}
                      ref={field.ref}
                    />
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 0) {
                          form.setValue("scheduledHours", value);
                        }
                      }}
                      ref={field.ref}
                    />
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 0) {
                          form.setValue("scheduledMinutes", value);
                        }
                      }}
                      ref={field.ref}
                    />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Cancellation status</FormLabel>
              <Select
                onValueChange={field.onChange}
                defaultValue={field.value}
                disabled={isSubmitting || disabled}
        ...
        <Button className="w-full" disabled={disabled || isSubmitting}>
          {id ? "Save changes" : "Create Pay on receive"}
        </Button>
      </form>
    </Form>
  );
